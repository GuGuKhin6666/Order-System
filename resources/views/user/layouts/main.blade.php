        ...
        <div class="row px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                <a class="btn d-flex align-items-center justify-content-between  w-100" data-toggle="collapse" href="#navbar-vertical" style="height: 65px; padding: 0 30px;">
                    <h6 class="text-white m-0 "><i class="fa fa-bars mr-2"></i>Pizza House</h6>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="{{route('send#mail')}}" class="nav-item nav-link">Contact</a>
                        </div>
                        <div class="dropdown">
                            <button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                             <i class="fa-sharp fa-solid fa-user me-3"></i>{{Auth::user()->name}}
                            </button>
                            <ul class="dropdown-menu">
                              <li><a class="dropdown-item" href="{{route('edit#page',Auth::user()->id)}}">Accout</a></li>
                              <li><a class="dropdown-item" href="{{route('edit#password')}}">Change Password</a></li>
                              <li><span class="dropdown-item">
                                <div class="btn px-0 ml-3">
                                    <form action="{{route('logout')}}" method="POST">
                                        @csrf
                                        <button type="submit" class=" text-secondary btn btn-dark text-white" ><i class="fa-solid fa-right-from-bracket me-3"></i>Logout</button>
                                    </form>
                                </div>
                            </span></li>
                            </ul>
    ...
    <div class="container-fluid bg-dark text-secondary mt-5 pt-5">
        ...
        <div class="row border-top mx-xl-5 py-4" style="border-color: rgba(256, 256, 256, .1) !important;">
            ...
            <div class="col-md-6 px-xl-0 text-center text-md-right">
                <img class="img-fluid" src="{{asset('customer/img/payments.png')}}" alt="">
            </div>
        </div>
    </div>
    <!-- Footer End -->
