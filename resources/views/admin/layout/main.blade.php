                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="{{route('product#list')}}" class="text-decoration-none">
                                <i class="fa-sharp fa-solid fa-list-ul text-primary"></i>Product</a>
                        </li>
                        <li>
                            <a href="{{route('order#listpage')}}" class="text-decoration-none">
                                <i class="fa-sharp fa-solid fa-list-check text-primary"></i>Order List</a>
                        </li>
                        <li>
                            <a href="{{route('data#return')}}" class="text-decoration-none">
                                <i class="fa-sharp fa-solid fa-users text-primary"></i>User List</a>
                        </li>
                        <li>
                            <a href="{{route('mail#listpage')}}" class="text-decoration-none">
                                <i class="fa-sharp fa-solid fa-paper-plane text-primary"></i>Contact Mail Lists</a>
                        </li>
                    </ul>
                </nav>
            </div>
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            ...
                                            <img src="{{asset('img/default_user.png')}}"  class="rounded-pill" style="width:50px;" alt="">
                                            @else                            
                                            <img src="{{asset('storage/'.Auth::user()->image)}}" class="rounded-pill" style="width:45px;height:45px;" alt="John Doe" />
                                            @endif
                                        </div>
                                        <div class="content">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__footer">
                                                <a href="{{route('editadmin#account')}}">
                                                    <i class="fa-sharp fa-solid fa-key"></i>Admin accounts</a>
                                            </div>
                                            <div class="account-dropdown__footer">
