                ...
                <div class="card">
                    <div class="card-body">
                        <div>
                            ...
                            <div>
                                <button class="btn btn-dark text-white" onclick="history.back()"><i class="fa-sharp fa-solid fa-arrow-left-long"></i></button>
                            </div>
                        </div>
                        <hr>
                        ...
                        @endif
                        <form action="{{route('update#password',Auth::user()->id)}}" method="post" novalidate="novalidate">
                            @csrf
                            ...
                            <div class="mt-3">
                                <button id="payment-button" type="submit" class="btn btn-lg btn-primary btn-block w-100">
