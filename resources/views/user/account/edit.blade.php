                ...
                <div class="card">
                     <div class="card-body row">
                        <div class="card-title col-12">
                            <h3 class="text-center title-2 mt-2">Edit User Profile</h3>
                            <hr class="mt-3">
                        </div>
                        <form action="{{route('update#page',Auth::user()->id)}}" method="post" novalidate="novalidate" enctype="multipart/form-data">
                            @csrf
